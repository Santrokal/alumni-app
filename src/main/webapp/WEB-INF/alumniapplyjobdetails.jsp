...
.nav-item:hover #google_translate_element {
	display: block;
}
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark">
		<div class="container">
			<a class="navbar-brand" href="<%=request.getContextPath()%>/home">Sacred
				Heart College Autonomous</a>
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu">
							<li><a class="dropdown-item"
								href="<%=request.getContextPath()%>/contactus">Contact</a></li>
							<li><a class="dropdown-item"
								href="<%=request.getContextPath()%>/directory">Directory</a></li>
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu">
							<li><a class="dropdown-item"
								href="<%=request.getContextPath()%>/stories">Alumni Story</a></li>
							<li><a class="dropdown-item" href="#">Latest Members</a></li>
							<li><a class="dropdown-item"
								href="<%=request.getContextPath()%>/profile">Alumni
									Profile</a></li>
						</ul></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#" id="storiesDropdown"
						...
						<ul class="dropdown-menu">
							...
							<!-- <li><a class="dropdown-item" href="#">World Level
									Mentors</a></li> -->
							<li><a class="dropdown-item"
								href="<%=request.getContextPath()%>/ourrecut">Our Recurits</a></li>
						</ul></li>
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu">
							<li><a class="dropdown-item"
								href="<%=request.getContextPath()%>/applyjob">Apply To Job</a></li>
						</ul></li>
					...
					<li class="nav-item">
						<div class="translate-wrapper">
							<i class="fas fa-globe translate-icon"
								onclick="toggleTranslateDropdown()"></i>
	...
	<div class="container mt-4">
     ...
     style="max-height: 200px; width: auto;">
					...
					<div class="col-md-8">
						...
						<h5>
							<strong>Job Posture / Job Description File:</strong>
						</h5>
						<%
						if (fileExtension.equals("jpg") || fileExtension.equals("jpeg") || fileExtension.equals("png")) {
						%>
						<img
							src="<%=request.getContextPath()%>/downloadFile/<%=company.getId()%>"
						...
						%>
						<a
							href="<%=request.getContextPath()%>/downloadFile/<%=company.getId()%>"
							class="btn btn-primary" target="_blank">Download File</a>
						<%
						}
						%>
		...
		<div class="text-center">
			<a
				href="<%=request.getContextPath()%>/alumniapplytojob?companyId=<%=company.getId()%>"
