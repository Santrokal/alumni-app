...
<style>
    ...
    .container-1 {
        ...
        .form-container {
            max-width: 450px; /* Small container */
            background: #ffffff;
            padding: 20px;
            border-radius: 10px;
...
<!-- Add Story Section -->
    ...
    <div class="form-container">
        <h4 class="text-center mb-3">Submit Your Story</h4>
        <form id="storiesForm" onsubmit="submitForm(event)" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea id="content" name="content" class="form-control" rows="4" required aria-label="Story Content"></textarea>
            </div>
            <div class="mb-3">
                <label for="linkedinProfile" class="form-label">LinkedIn Profile:</label>
                <input type="url" id="linkedinProfile" name="linkedinProfile" class="form-control" aria-label="LinkedIn Profile URL">
            </div>
            <div class="mb-3">
                <label for="department" class="form-label">Department: <span class="text-danger">*</span></label>
                <input type="text" id="department" name="department" class="form-control" required aria-label="Department">
            </div>
            <div class="mb-3">
                <label for="organization" class="form-label">Organization:</label>
                <input type="text" id="organization" name="organization" class="form-control" aria-label="Organization">
            </div>
            <div class="mb-3">
                <label for="storyImage" class="form-label">Upload Story Image: <span class="text-danger">*</span></label>
                <input type="file" id="storyImage" name="storyImage" class="form-control" accept="image/*" required aria-label="Story Image">
            </div>
            <div class="mb-3 form-check">
                <input type="checkbox" id="consentToPublish" name="consentToPublish" class="form-check-input" aria-label="Consent to Publish">
                <label for="consentToPublish" class="form-check-label">I consent to publish this story</label>
            </div>
